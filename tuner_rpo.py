...
tuner = Tuner(
    ...
    params_fn=lambda trial: {
        ...
        "num-steps": trial.suggest_categorical("num-steps", [16, 32, 64, 128, 256, 512]),
        ...
        "rpo-alpha": trial.suggest_uniform("rpo-alpha", 0, 1),
        "gamma": trial.suggest_uniform("gamma", 0.95, 0.999),
        "ent-coef": trial.suggest_uniform("eng-coef", 0, 0.01),
